...
abd_inter_data_root = '/data/sdd/user/processed_data/abd_CT_MRI/image-regis_0/'
abd_inter_mask_root = '/data/sdd/user/processed_data/abd_CT_MRI/mask-regis_0/'
...
data = dict(
    ...
    train=dict(
        ...
        datasets=[abd_intra_set, lymphnode_intra_set]
    ),
    val=dict(
